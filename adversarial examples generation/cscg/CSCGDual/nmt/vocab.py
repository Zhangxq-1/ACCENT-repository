...
import torch
from CSCGDual.nmt.util import read_corpus
import sys
...
class Vocab(object):
    def __init__(self, src_sents, tgt_sents, src_vocab_size, tgt_vocab_size, remove_singleton=True):
        assert len(src_sents) == len(tgt_sents), '{} {}'.format(len(src_sents), len(tgt_sents))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_src', type=str, required=False, default='/home/zxq/code/zxq12-CSCGDual-master/CSCGDual/data/java/train.token.code')
    parser.add_argument('--train_tgt', type=str, required=False, default='/home/zxq/code/zxq12-CSCGDual-master/CSCGDual/data/java/train.token.nl')
