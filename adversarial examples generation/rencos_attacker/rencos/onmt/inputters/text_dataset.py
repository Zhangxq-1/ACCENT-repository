...
class TextDataset(DatasetBase):
    ...
    def __init__(self, fields, src_examples_iter, tgt_examples_iter,
        ...
        if ref_examples_iter is not None:
            if tgt_examples_iter is not None:
                ...
                #print(1)#这里运行
                #for item in zip(src_examples_iter, zip(*ref_examples_iter)):
                    #d=self._join_dicts(list(y for x in item for y in (x if isinstance(x, tuple) else (x,))))
                    #print(d.keys())   #dict_keys(['src', 'indices', 'ref0', 'ref1'])  还是原token
                    #exit(0)
        ...
        keys = ex.keys()
        #print(keys)   dict_keys(['src', 'indices', 'ref0', 'ref1'])
        out_fields = [(k, fields[k]) if k in fields else (k, fields['ref'])
                      for k in keys]
        #print(out_fields)
        #[('src', <torchtext.data.field.Field object at 0x7f4426497048>), ('indices', <torchtext.data.field.Field object at 0x7f4426497160>), ('ref0', <torchtext.data.field.Field object at 0x7f4426497080>), 
        #('ref1', <torchtext.data.field.Field object at 0x7f4426497080>)]
        ...
        #print('out_exmples')
        #print(out_examples[0:2])  
        #<torchtext.data.example.Example object at 0x7fa3f9ef12e8>, <torchtext.data.example.Example object at 0x7fa3f9ef4c88>]
    ...
    def make_text_examples_nfeats_tpl(text_iter, text_path, truncate, side):
        ...
        examples_nfeats_iter = \
            TextDataset.make_examples(text_iter, truncate, side)  #make_examples  返回example_dict  样本--索引字典
        ...
        #print(first_ex)
        '''
        ({'src': ('protected', 'boolean', '[', ']', 'dataset', 'Integrity', '(', 'boolean', 'nominal', 'Predictor', ',', 'boolean', 'numeric', 'Predictor', ',', 'boolean', 'string', 'Predictor', ',', 'boolean', 'date', 'Predictor', ',', 'boolean', 'relational', 'Predictor', ',', 'boolean', 'multi', 'Instance', ',', 'int', 'class', 'Type', ',', 'boolean', 'predictor', 'Missing', ',', 'boolean', 'class', 'Missing', ')', '{', 'print', '(', '_', 'STR', ')', ';', 'print', 'Attribute', 'Summary', '(', 'nominal', 'Predictor', ',', 'numeric', 'Predictor', ',', 'string', 'Predictor', ',', 'date', 'Predictor', ',', 'relational', 'Predictor', ',', 'multi', 'Instance', ',', 'class', 'Type', ')', ';', 'print', '(', '_', 'STR', ')', ';', 'int', 'num', 'Train', '=', 'get', 'Num', 'Instances', '(', ')', ',', 'num', 'Classes', '=', '_', 'NUM', ',', 'missing', 'Level', '=', '_', 'NUM', ';', 'boolean', '[', ']', 'result', '=', 'new', 'boolean', '[', '_', 'NUM', ']', ';', 'Instances', 'train', '=', 'null', ';', 'Kernel', 'kernel', '=', 'null', ';', 'try', '{', 'train', '=', 'make', 'Test', 'Dataset', '(', '_', 'NUM', ',', 'num', 'Train', ',', 'nominal', 'Predictor', '?', 'get', 'Num', 'Nominal', '(', ')', ':', '_', 'NUM', ',', 'numeric', 'Predictor', '?', 'get', 'Num', 'Numeric', '(', ')', ':', '_', 'NUM', ',', 'string', 'Predictor', '?', 'get', 'Num', 'String', '(', ')', ':', '_', 'NUM', ',', 'date', 'Predictor', '?', 'get', 'Num', 'Date', '(', ')', ':', '_', 'NUM', ',', 'relational', 'Predictor', '?', 'get', 'Num', 'Relational', '(', ')', ':', '_', 'NUM', ',', 'num', 'Classes', ',', 'class', 'Type', ',', 'multi', 'Instance', ')', ';', 'if', '(', 'missing', 'Level', '>', '_', 'NUM', ')', '{', 'add', 'Missing', '(', 'train', ',', 'missing', 'Level', ',', 'predictor', 'Missing', ',', 'class', 'Missing', ')', ';', '}', 'kernel', '=', 'Kernel', '.', 'make', 'Copies', '(', 'get', 'Kernel', '(', ')', ',', '_', 'NUM', ')', '[', '_', 'NUM', ']', ';', '}', 'catch', '(', 'Exception', 'ex', ')', '{', 'throw', 'new', 'Error', '(', '_', 'STR', '+', 'ex', '.', 'get', 'Message', '(', ')', ')', ';', '}', 'try', '{', 'Instances', 'train', 'Copy', '=', 'new', 'Instances',
         '(', 'train', ')', ';', 'kernel', '.', 'build', 'Kernel', '(', 'train', 'Copy', ')', ';', 'compare'), 'indices': 0}, 0)
        '''
        ...
        '''   ex:
        {'src': ('protected', 'boolean', '[', ']', 'dataset', 'Integrity', '(', 'boolean', 'nominal', 'Predictor', ',', 'boolean', 'numeric', 'Predictor', ',', 'boolean', 'string', 'Predictor', ',', 'boolean', 'date', 'Predictor', ',', 'boolean', 'relational', 'Predictor', ',', 'boolean', 'multi', 'Instance', ',', 'int', 'class', 'Type', ',', 'boolean', 'predictor', 'Missing', ',', 'boolean', 'class', 'Missing', ')', '{', 'print', '(', '_', 'STR', ')', ';', 'print', 'Attribute', 'Summary', '(', 'nominal', 'Predictor', ',', 'numeric', 'Predictor', ',', 'string', 'Predictor', ',', 'date', 'Predictor', ',', 'relational', 'Predictor', ',', 'multi', 'Instance', ',', 'class', 'Type', ')', ';', 'print', '(', '_', 'STR', ')', ';', 'int', 'num', 'Train', '=', 'get', 'Num', 'Instances', '(', ')', ',', 'num', 'Classes', '=', '_', 'NUM', ',', 'missing', 'Level', '=', '_', 'NUM', ';', 'boolean', '[', ']', 'result', '=', 'new', 'boolean', '[', '_', 'NUM', ']', ';', 'Instances', 'train', '=', 'null', ';', 'Kernel', 'kernel', '=', 'null', ';', 'try', '{', 'train', '=', 'make', 'Test', 'Dataset', '(', '_', 'NUM', ',', 'num', 'Train', ',', 'nominal', 'Predictor', '?', 'get', 'Num', 'Nominal', '(', ')', ':', '_', 'NUM', ',', 'numeric', 'Predictor', '?', 'get', 'Num', 'Numeric', '(', ')', ':', '_', 'NUM', ',', 'string', 'Predictor', '?', 'get', 'Num', 'String', '(', ')', ':', '_', 'NUM', ',', 'date', 'Predictor', '?', 'get', 'Num', 'Date', '(', ')', ':', '_', 'NUM', ',', 'relational', 'Predictor', '?', 'get', 'Num', 'Relational', '(', ')', ':', '_', 'NUM', ',', 'num', 'Classes', ',', 'class', 'Type', ',', 'multi', 'Instance', ')', ';', 'if', '(', 'missing', 'Level', '>', '_', 'NUM', ')', '{', 'add', 'Missing', '(', 'train', ',', 'missing', 'Level', ',', 'predictor', 'Missing', ',', 'class', 'Missing', ')', ';', '}', 'kernel', '=', 'Kernel', '.', 'make', 'Copies', '(', 'get', 'Kernel', '(', ')', ',', '_', 'NUM', ')', '[', '_', 'NUM', ']', ';', '}', 'catch', '(', 'Exception', 'ex', ')', '{', 'throw', 'new', 'Error', '(', '_', 'STR', '+', 'ex', '.', 'get', 'Message', '(', ')', ')', ';', '}', 'try', '{', 'Instances', 'train', 'Copy', '=', 'new', 'Instances',
         '(', 'train', ')', ';', 'kernel', '.', 'build', 'Kernel', '(', 'train', 'Copy', ')', ';', 'compare'), 'indices': 0}
        '''
        #print('examples_nfeats_iter')
        #print(examples_nfeats_iter)  #<itertools.chain object at 0x7f92864137f0>
        #print('num+feats')
        #print(num_feats)  #0

        #print('examples_iter')
        #print(examples_iter)
        return (examples_iter, num_feats)  #( ({}, {}, {}, {},{}), num_feats)
    ...
    def make_examples(text_iter, truncate, side):
        ...
        for i, line in enumerate(text_iter):
            ...
            #样本字典  数据--索引  words是['protected', 'boolean', '[', ']', 'can', 'Handle', 'Missing', '(',...]
            if feats:  # feats =0
                prefix = side + "_feat_"
