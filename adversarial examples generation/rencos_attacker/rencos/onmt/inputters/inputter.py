...
def build_dataset(fields, data_type, src_data_iter=None, src_path=None,
    ...
    print('src_examples_iter')
    #print(src_examples_iter)  
    #src_list=list(src_examples_iter)
    #print(len(src_list))
...
class OrderedIterator(torchtext.data.Iterator):
    ...
    def create_batches(self):
        ...
        if self.train:
            ...
            #print('OrderedIterator  else')  OrderedIterator  else
            self.batches = []
            #print('self.batch_size_fn')
            #print(self.batch_size_fn)
            ...
            #print(len(self.batches))  203   203*32 
