...
def train_vocab(size):
    ...
    if not os.path.exists( '/home/zxq/code/var_attacker/attacker/encoder/vocab/train'):
        os.mkdir('/home/zxq/code/var_attacker/attacker/encoder/vocab/train')

    w2v = Word2Vec(corpus, size=size, workers=16, sg=1, min_count=3)
    w2v.save('/home/zxq/code/var_attacker/attacker/encoder/vocab/train/node_w2v_code_' + str(size))
