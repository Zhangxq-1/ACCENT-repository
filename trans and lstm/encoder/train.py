...
def train(model, train_data, optimizer, criterion):
    ...
    for epoch in range(EPOCHES):
        ...
        if avg_loss < old_loss:
            torch.save(model.state_dict(),'/home/zxq/code/var_attacker/attacker/encoder/model.pkl')
            old_loss=avg_loss
...
if __name__ == '__main__':
    ...
    data=pd.read_pickle('/home/zxq/code/var_attacker/attacker/encoder/train_data.pkl')
    print('read embedding....')
    root = '/home/zxq/code/var_attacker/attacker/encoder'
