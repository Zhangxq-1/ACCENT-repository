...
def vectorize_adv(ex, src_dict,tgt_dict):
    """Torchify a single example."""
    src_dict = src_dict
    tgt_dict = tgt_dict
    use_src_word=True
    ...
    return {
        ...
        'summ_tokens': summary.tokens,
        'src_vocab': code.src_vocab,
        'use_src_word': use_src_word,
        'use_tgt_word': use_tgt_word,
        'use_src_char': use_src_char,
        'use_tgt_char': use_tgt_char,
