...
from c2nl.inputters.vector import vectorize,vectorize_adv
...
class CommentDataset_adv(Dataset):
    def __init__(self, examples, src_dict,tgt_dict):
        #self.model = model
        self.examples = examples   # a list
    ...
    def __getitem__(self, index):
        return vectorize_adv(self.examples[index],self.src_dict,self.tgt_dict )
