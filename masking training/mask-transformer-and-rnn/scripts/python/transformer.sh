...
MODEL_DIR=${SRC_DIR}/tmp-trans-mask-python-0.7-0.3
...
--model_dir $MODEL_DIR \
--model_name $MODEL_NAME \
--dev_src test/code_adv_3.${CODE_EXTENSION} \
--dev_src_tag test/code_adv_3.${CODE_EXTENSION}\
--dev_tgt test/javadoc.${JAVADOC_EXTENSION} \
--code_tag_type $CODE_EXTENSION \
--use_code_type False \
--uncase True \
...
#cscgcode_adv_3   20.87
#CSCG_MH2_adv_code_3 22.60

#code_random_adv2  25.76
#code_random_adv3   24.69
