...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_src', type=str, required=False, default='/data/java/train.token.code')
    parser.add_argument('--train_tgt', type=str, required=False, default='/data/java/train.token.nl')
